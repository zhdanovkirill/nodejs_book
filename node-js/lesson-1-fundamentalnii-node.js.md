...
* Не-відплив: код і дані, які впираються в обмеження пам'яті. Обмеження можуть бути або штучними - закладеними в мову або середовище виконання, або природними - що випливають із характеристик заліза, на якому виконується код.
